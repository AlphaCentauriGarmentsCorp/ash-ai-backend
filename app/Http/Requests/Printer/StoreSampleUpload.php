...
/**
 * Phase 5-C — Sample upload form request for the Printer portal.
 *
 * Validation is identical to Cutter's version because both write to
 * stage_sample_uploads. Separate request classes keep namespacing clean
 * and allow future per-portal customization (e.g., printer-specific
 * required notes).
 */
